...
class MigrationRunner:
    ...
    def create_migrations_table(self):
        ...
        logger.info("Migrations table setup (manual creation required in Supabase dashboard)")
        return True
    ...
    def get_executed_migrations(self) -> List[str]:
        ...
        try:
            result = client.table('schema_migrations').select('migration_name').order('id').execute()
    ...
    def execute_migration(self, file_path: Path) -> bool:
        ...
        try:
            ...
            logger.info(f"Please execute the following SQL in Supabase dashboard:")
    ...
    def run_migrations(self, target_migration: Optional[str] = None) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully executed {success_count}/{len(pending_migrations)} migrations")
