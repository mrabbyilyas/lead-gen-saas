...
class CompanyService(SupabaseService):
    ...
    def create_company(
        self, company_data: CompanyCreate, user_id: str
    ) -> CompanyResponse:
    ...
    def update_company(
        self, company_id: Union[str, UUID], company_data: CompanyUpdate
    ...
    def search_companies(
        ...
        try:
            ...
            # Get total count
            count_query = self.table.select("*", count="exact").eq(
                "created_by", user_id
            )
...
class ContactService(SupabaseService):
    ...
    def create_contact(
        self, contact_data: ContactCreate, user_id: str
    ) -> ContactResponse:
    ...
    def update_contact(
        self, contact_id: Union[str, UUID], contact_data: ContactUpdate
...
class ScrapingJobService(SupabaseService):
    ...
    def create_job(
        self, job_data: ScrapingJobCreate, user_id: str
    ) -> ScrapingJobResponse:
    ...
    def update_job(
        self, job_id: Union[str, UUID], job_data: ScrapingJobUpdate
    ...
    def update_job_progress(
        self, job_id: Union[str, UUID], progress_data: Dict[str, Any]
    ) -> Optional[ScrapingJobResponse]:
    ...
    def get_active_jobs(self, user_id: str) -> List[ScrapingJobResponse]:
        ...
        filters = {"created_by": user_id, "status": ["pending", "running"]}
...
class ScrapedDataService(SupabaseService):
    ...
    def get_scraped_data(
        self, data_id: Union[str, UUID]
    ) -> Optional[ScrapedDataResponse]:
    ...
    def update_scraped_data(
        self, data_id: Union[str, UUID], data: ScrapedDataUpdate
    ) -> Optional[ScrapedDataResponse]:
        """Update scraped data."""
        data_dict = data.model_dump(exclude_unset=True)
...
class DataExportService(SupabaseService):
    ...
    def create_export(
        self, export_data: DataExportCreate, user_id: str
    ) -> DataExportResponse:
    ...
    def update_export(
        self, export_id: Union[str, UUID], export_data: DataExportUpdate
    ) -> Optional[DataExportResponse]:
...
class APIKeyService(SupabaseService):
    ...
    def update_api_key(
        self, key_id: Union[str, UUID], key_data: APIKeyUpdate
