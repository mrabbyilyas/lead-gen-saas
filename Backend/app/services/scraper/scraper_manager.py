...
from .scraper_factory import (
    ScraperFactory, ScraperType, scraper_factory, create_scraper, auto_select_scraper
)
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            'scraper_type': self.scraper_type.value 
                if isinstance(self.scraper_type, ScraperType) else self.scraper_type,
    ...
    async def cleanup_old_jobs(self, max_age_hours: int = 24) -> int:
        ...
        for job_id, job in self.jobs.items():
            ...
            if job.status not in [
                ...
                ScrapingStatus.CANCELLED, ScrapingStatus.BLOCKED,
