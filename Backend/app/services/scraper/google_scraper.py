...
class GoogleScraper(BaseScraper):
    ...
    async def _scrape_google_maps(self, query: str, location: str, result: ScrapingResult) -> List[Dict]:
        ...
        try:
            ...
            for element in business_elements[:self.config.max_pages * 10]:  # Limit results
                try:
                    business_data = await self._extract_maps_business_data(driver, element)
                    if business_data:
    ...
    async def _scrape_google_search(self, query: str, location: str, result: ScrapingResult) -> List[Dict]:
    ...
    def _merge_results(self, result: ScrapingResult, maps_results: List[Dict], 
